                ...
                <div class="form-body p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="profesion" name="profesion" class="search-input" style="padding-left: 12px !important;">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Especialización</label>
                            <input type="text" id="especializacion" name="especializacion" class="search-input" style="padding-left: 12px !important;">
                        </div>
