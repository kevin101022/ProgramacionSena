...
<main class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <!-- Action Bar -->
        <div class="action-bar bg-white/50 backdrop-blur-sm border border-slate-100 p-4 rounded-3xl flex items-center gap-4 mb-6 shadow-sm">
            ...
            <button onclick="coordinacionModule.openModal()" class="btn-primary shadow-md hover:shadow-lg transition-all scale-100 active:scale-95">
            ...
            <table class="data-table w-full text-left">
                <thead>
                    <tr class="bg-slate-50/50">
                        ...
                        <th class="py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest">Nombre del Área</th>
                        <th class="py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest">Centro de Formación</th>
                    </tr>
                </thead>
            ...
            <div class="pagination-container border-t border-slate-50 p-6 flex flex-wrap items-center justify-between gap-4">
                <div class="pagination-info">
                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-wider">
                        Mostrando <span id="showingFrom" class="text-sena-green">0</span> a <span id="showingTo" class="text-sena-green">0</span> de <span id="totalRecords" class="text-sena-green font-black">0</span> áreas
                    </p>
                </div>
