<?php
$pageTitle = "Calendario de Instructor - SENA";
    ...
    <header class="main-header">
        <div class="header-content">
            <nav class="breadcrumb">
                ...
                <span>Calendario de Instructor</span>
            </nav>
            <h1 class="page-title">Calendario de Instructor</h1>
        </div>
    </header>
    ...
    <div class="content-wrapper">
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-card-body">
                    ...
                    <span class="stat-card-desc">programadas para este instructor</span>
                    <p class="stat-card-context">Carga académica completa del instructor seleccionado.</p>
                </div>
        ...
        <div class="action-bar flex-col md:flex-row gap-4">
            <div class="w-full max-w-lg relative">
                ...
                <input type="text" id="instructorSearch" autocomplete="off" placeholder="Buscar instructor por nombre o documento..." class="search-input w-full pl-10" style="padding-left: 2.5rem !important; border-radius: 12px;">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-4">
            <div id="calendarPlaceholder" class="calendar-placeholder" style="text-align: center; padding: 3rem;">
                <ion-icon src="../../assets/ionicons/person-outline.svg" style="font-size: 4rem; color: #e5e7eb; margin-bottom: 1rem;"></ion-icon>
                <p class="text-lg font-semibold text-gray-700">Seleccione un instructor</p>
                <p class="text-sm text-gray-500">El calendario mostrará todas las asignaciones del instructor</p>
            </div>
    ...
    <div class="modal-content" style="max-width: 500px;">
        ...
        <div class="modal-body" style="padding: 24px;">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0">
                        <ion-icon src="../../assets/ionicons/school-outline.svg" class="text-amber-500"></ion-icon>
                    </div>
                    <div class="flex-1">
